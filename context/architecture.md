# 📚 ShikhonBD — সম্পূর্ণ প্রজেক্ট আর্কিটেকচার প্ল্যান
...
### AI
```
Primary       : Anthropic Claude (claude-sonnet)
...
```
SUPER_ADMIN      → প্ল্যাটফর্ম মালিক (ShikhonBD টিম)
...
| পারমিশন | SUPER | ORG_OWNER | ORG_ADMIN | TEACHER | STUDENT |
|---|:---:|:---:|:---:|:---:|:---:|
| প্রশ্ন জেনারেট করা | ✅ | ✅ | ✅ | ✅ | ❌ |
...
Font (বাংলা)  : Hind Siliguri / Kalpurush
Font (English) : Plus Jakarta Sans
```
...
- [x] Bilingual (বাংলা/English) সম্পূর্ণ
- [x] PWA সেটআপ
