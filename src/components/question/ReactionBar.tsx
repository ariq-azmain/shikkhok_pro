...
interface Props {
    ...
    // Feed card এ comment click করলে detail page এ যাবে
    onCommentClick?: () => void;
    // Detail page এ comment section toggle করবে
...
export default function ReactionBar({
    ...
    const {
        ...
        count: likeCount,
        toggle
    } = useLike(questionId, initialLikes);
        ...
        <div className="flex items-center gap-1">
            ...
            <button
                ...
                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-sm font-medium transition-all duration-150 ${
                    liked ? "text-rose-400 bg-rose-400/10" : "hover:bg-white/5"
                }`}
            ...
            <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-sm font-medium transition-all duration-150 hover:bg-white/5"
