...
// ---------------------------------------------------------------
// Settings tab — edit displayName, bio, avatar.
// Only rendered for the profile owner.
// ---------------------------------------------------------------
"use client";
      ...
      <div>
        ...
        <div
          className={cn(
            ...
            "bg-white/3 border border-white/5 text-gray-500 select-none cursor-not-allowed"
          )}
        >
          @{profile.username}
        </div>
