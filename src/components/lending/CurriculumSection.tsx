      ...
      <div className="max-w-6xl mx-auto">
        <div ref={titleRef} className="text-center mb-14">
          ...
          <p className="text-lg max-w-2xl mx-auto" style={{ color: "#94a3b8" }}>
            Every subject, every class, every topic — from the official NCTB
            textbooks. Our AI knows the Bangladesh curriculum so you don't have
            to explain it.
          </p>
        </div>
        ...
        >
          <div>
            ...
            <p className="text-sm" style={{ color: "#94a3b8" }}>
              Using a custom curriculum or textbook? Add custom prompts and our
              AI adapts instantly.
            </p>
          </div>
          <Link href="/sign-in">
