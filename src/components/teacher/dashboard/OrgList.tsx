          ...
          <div className="space-y-2">
            {orgsOwned.map((o) => (
              <button
                ...
                className="w-full flex items-center gap-3 p-3 rounded-lg bg-muted-10 hover:bg-muted-20 transition"
              >
                {o.logo ? (
                  ...
                  <div className="w-9 h-9 rounded-full bg-indigo-500 flex items-center justify-center text-xs font-semibold text-white">
            ...
            memberOnly.map((o) => (
              ...
              >
                {o.logo ? (
                  ...
                  <div className="w-9 h-9 rounded-full bg-cyan-500 flex items-center justify-center text-xs font-semibold text-white">
                    {o.name?.[0]?.toUpperCase()}
                  </div>
                )}
                <div className="text-left flex-1">
