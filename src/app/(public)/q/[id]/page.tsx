...
export default function QuestionDetailPage() {
  ...
  if (error || !question) {
    return (
      ...
      >
        ...
        <Link href="/q" className="text-sm text-indigo-400 hover:underline">
          ← Back to Feed
        </Link>
      </main>
    );
  ...
  const totalQs =
    question.content.sections?.reduce(
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-4 py-8">
        ...
        {/* Question card */}
        <article
          className="rounded-2xl border border-white/5 overflow-hidden mb-4"
        ...
        >
          ...
          <div className="p-6">
            ...
            {/* Title */}
            <h1
              className="text-xl font-extrabold leading-snug mb-4"
              style={{ color: "var(--text-primary)" }}
            >
              {question.title}
            </h1>
            ...
            <div className="flex flex-wrap gap-2 mb-5">
              ...
              <span
                className={`text-xs font-semibold px-3 py-1 rounded-full border ${difficulty.className}`}
              >
                {difficulty.label}
              </span>
            </div>
              ...
              {[
                {
                  icon: Award,
                  label: "Total Marks",
                  value: question.totalMarks ? `${question.totalMarks}` : "—",
                },
                {
                  icon: Clock,
                  label: "Duration",
